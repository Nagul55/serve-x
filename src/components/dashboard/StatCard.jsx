...
export default function StatCard({ title, value, subtitle, icon: Icon, color = 'blue', trend }) {
  ...
  return (
    <motion.div
      ...
      className="bg-card rounded-xl border border-border p-4 sm:p-5 flex flex-col gap-3"
    >
      ...
      <div>
        <div className="text-2xl sm:text-3xl font-bold font-jakarta text-foreground">{value}</div>
